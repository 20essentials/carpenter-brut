...
const nameSongs = [
	...
	"ROLLER MOBSTER", /*6*/
	"LEATHER TEETH ", /*7*/
	"ESCAPE FROM MIDWICH VALLEY", /*8*/
	"CHEWING GUM AND KICK ASS", /*9*/
	"LOOKING FOR TRACY TENTS", /*10*/
	"DIVISION RUINE", /*11*/
	"ANARCHY ROAD", /*12*/
	"RUN, SALLY, RUN!", /*13*/
	"INVASION AD", /*14*/
	"DISCO ZOMBIE ITALO CONNECTION", /*15*/
	"NIGHT STALKER", /*16*/
	"SEXKILLER ON THE LOOSE", /*17*/
	"MEET MATT STRIKER", /*18*/
	"OBITUARY", /*19*/
	"MIDNIGHT DEMONS", /*20*/
]
